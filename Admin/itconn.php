<?php
  ...
  if($validUser === true){
      $InsertSql = "Insert into itadmintable(username,password,fullname,position,deleted) values('$Uname','$Pword','$Fname','IT Admin','OFF'); ";
      if($CPword === $Pword){
        if($conn->query($InsertSql) === true){
          echo "<script>
                alert('IT Admin Successfully Registred');
