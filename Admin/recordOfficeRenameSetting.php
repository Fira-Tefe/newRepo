<?php
    ...
    $rselect = $conn->prepare("SELECT * FROM admintable WHERE fullname = ? AND password = ?");
    ...
    if ($rresult->num_rows > 0) {
        ...
        $updateAdmin = $conn->prepare("UPDATE admintable SET fullname = ?, username = ?, password = ? WHERE fullname = ? AND password = ?");
