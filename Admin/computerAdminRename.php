<?php
    ...
    $rselect = $conn->prepare("SELECT * FROM computeradmintable WHERE fullname = ? AND password = ?");
    ...
    if ($rresult->num_rows > 0) {
        ...
        $updateAdmin = $conn->prepare("UPDATE computeradmintable SET fullname = ?, username = ?, password = ? WHERE fullname = ? AND password = ?");
