<?php
  ...
  $validUser = true;
    ...
    if($validUser === true){
          $InsertSql = "Insert into computeradmintable(username,password,fullname,position,deleted) values('$Uname','$Pword','$Fname','Computer Admin','OFF'); ";
          if($CPword === $Pword){
            if($conn->query($InsertSql) === true){
              echo "<script>
                    alert('Computer Admin Successfully Registred');
